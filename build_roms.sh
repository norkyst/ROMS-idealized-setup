...
export   ROMS_APPLICATION=idealized
...
# computers.
 ...
 #export       MY_ROMS_SRC=${MY_ROOT_DIR}/roms-seaice
...
#export         COMPILERS=${MY_ROMS_SRC}/Compilers # Original compilers
...
if [ $pio_lib -eq 1 ]; then
 ...
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DICE_MODEL"

 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DBULK_FLUXES"

 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DLMD_MIXING"

#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DDIAGNOSTIC_TS"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DDIAGNOSTIC_UV"
