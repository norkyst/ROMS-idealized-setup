...
#	   FFLAGS := -O3 -mcmodel=large -ip
           FFLAGS += 
       FIXEDFLAGS := 
        FREEFLAGS := 
              CPP := /usr/bin/cpp
#              CPP := /software/sse2/tetralith_el9/easybuild/pure/software/GCCcore/12.3.0/bin/cpp
#         CPPFLAGS := -P -traditional -O3      
...
ifdef USE_PIO
       PIO_INCDIR ?= /software/sse2/tetralith_el9/manual/pio_lib/2.6.2/hpc2-PnetCDF-intel-2023a-eb/include
       PIO_LIBDIR ?= /software/sse2/tetralith_el9/manual/pio_lib/2.6.2/hpc2-PnetCDF-intel-2023a-eb/lib
          FFLAGS += -I$(PIO_INCDIR)
            LIBS += -L$(PIO_LIBDIR) -lpiof -lpioc

    PNETCDF_INCDIR ?= /software/sse2/tetralith_el9/easybuild/pure/software/PnetCDF/1.12.3-intel-2023a/include
    PNETCDF_LIBDIR ?= /software/sse2/tetralith_el9/easybuild/pure/software/PnetCDF/1.12.3-intel-2023a/lib
